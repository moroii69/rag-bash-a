  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <div className="mb-16">
          <h1 className="text-4xl font-light mb-4 text-foreground">Terms of Service</h1>
          ...
          <div className="space-y-12">
            <div className="border-l-2 border-border pl-6">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm">
                By accessing and using bash-A, you accept and agree to be bound by the terms and
            ...
            <div className="border-l-2 border-border pl-6">
              <h2 className="text-2xl font-light mb-4 text-foreground">2. Use of Service</h2>
              <p className="text-muted-foreground leading-relaxed text-sm mb-4">
                bash-A is an AI chatbot service provided for informational and conversational
                purposes. You agree to use the service only for lawful purposes and in accordance
                with these terms.
              </p>
            ...
            <div className="border-l-2 border-border pl-6">
              <h2 className="text-2xl font-light mb-4 text-foreground">3. Intellectual Property</h2>
              <p className="text-muted-foreground leading-relaxed text-sm">
                The service and its original content, features, and functionality are owned by
                bash-A and are protected by international copyright, trademark, and other
                intellectual property laws.
              </p>
            </div>

            <div className="border-l-2 border-border pl-6">
              <h2 className="text-2xl font-light mb-4 text-foreground">4. Disclaimer</h2>
              <p className="text-muted-foreground leading-relaxed text-sm">
                bash-A is provided "as is" without warranties of any kind, either express or
            ...
            <div className="border-l-2 border-border pl-6">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm">
                In no event shall bash-A be liable for any indirect, incidental, special,
            ...
            <div className="border-l-2 border-border pl-6">
              <h2 className="text-2xl font-light mb-4 text-foreground">6. Changes to Terms</h2>
              <p className="text-muted-foreground leading-relaxed text-sm">
            ...
            <div className="border-l-2 border-border pl-6">
              <h2 className="text-2xl font-light mb-4 text-foreground">7. Contact</h2>
              <p className="text-muted-foreground leading-relaxed text-sm">
